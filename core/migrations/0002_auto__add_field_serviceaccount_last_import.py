...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ServiceAccount.last_import'
        db.add_column('core_serviceaccount', 'last_import', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'ServiceAccount.last_import'
        db.delete_column('core_serviceaccount', 'last_import')
